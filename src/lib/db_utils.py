"""Database utilities for HouseGPT PostgreSQL connection management.

Provides connection pooling, query execution, and data persistence utilities
for conversation logging, user preferences, and system state.
"""
